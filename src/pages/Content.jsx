                      ...
                      <div className="p-3">
                        ...
                        <div className="flex items-center justify-between text-xs text-gray-600 dark:text-gray-400 mb-1">
                          <span className="text-xs md:text-sm font-medium flex items-center gap-1">
                            <span className="block md:d-none text-[12px] md:text-sm">Ch</span> 
                            <span className="hidden md:d-block">Chapter</span> 
                            <span className="text-[12px] md:text-sm">{manga.lastChapters?.[0]?.number || 'N/A'}</span>
                          </span>
                        ...
                        {manga.rating > 0 && (
                          <div className="flex items-center space-x-1">
                            ...
                            <span className="text-[12px] md:text-sm font-medium text-gray-700 dark:text-gray-300">
                              {manga.rating}
                            </span>
                          </div>
                        )}
